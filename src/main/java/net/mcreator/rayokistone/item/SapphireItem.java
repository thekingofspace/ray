...
public class SapphireItem extends RayokiStoneModElements.ModElement {
	@ObjectHolder("rayoki_stone:sapphire")
	public static final Item block = null;
	public SapphireItem(RayokiStoneModElements instance) {
		super(instance, 28);
	}
